...
void display_draw_arc_with_radius(uint8_t x, uint8_t y, uint8_t inner_radius, uint8_t outer_radius, uint16_t start_angle, uint16_t sweep, display_color_t color);
